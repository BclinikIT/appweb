                                      ...
                                      <table width="100%" role="presentation" cellpadding="0" cellspacing="0">
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-infoblock" style="font-size:0">
                                              <a target="_blank">
                                                <img width="350" src="https://appweb.bclinik.com/img/img_correos/cribado02.png" alt="" class="adapt-img">
                                              </a>
                                            </td>
                                          </tr>
                                        </tbody>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td align="left" valign="top" width="100%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:10px">
                                                      <a target="_blank" href="https://wa.link/wcqioe" style="font-size:14px;color:#0f4761;font-weight:bold">
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td width="100%" align="left" valign="top" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:10px">
                                                      <a target="_blank" href="mailto:heydycachutt@bclinik.com" style="font-size:14px;color:#333333;font-weight:bold">
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td align="left" valign="top" width="100.00%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top:10px">
                                                      <a href="www.bclinik.com" target="_blank" style="color:#333333;font-weight:bold;font-size:14px">
