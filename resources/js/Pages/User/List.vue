                ...
                <div class="container mx-auto px-4 sm:px-8">
                    <div class="py-8">
                        ...
                        <div class="flex flex-row mb-1 sm:mb-0 justify-between w-full">
                            <h2 class="text-2xl leading-tight">Lista Usuario</h2>
                            <div class="flex">
                                ...
                                <table class="min-w-full leading-normal">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="dato in datosPaginados" :key="dato.id">
                                            ...
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.name }}</td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.email }}</td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.created_at }}</td>
