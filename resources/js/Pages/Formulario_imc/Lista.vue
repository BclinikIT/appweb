                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                    ...
                    <div class="bg-white overflow-hidden shadow rounded-lg">
                        <div class="px-4 py-5 sm:p-6 flex items-center">
                            <svg
                                class="h-8 w-8 text-gray-500 mr-3"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="flex">
                    <div class="w-1/5 pr-4">
                        ...
                        <div class="mt-4">
                            <label
                                class="block text-sm font-medium text-gray-700"
                                >Filtrar por Rango de Edades:</label
                            >
                            <select
                                v-model="filtroEdad"
                                class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
                        ...
                        >
                            ...
                            >
                                <table class="min-w-full leading-normal">
                                    ...
                                    <tbody>
                                        <tr
                                            v-for="dato in datosPaginados"
                                            :key="dato.id"
                                        >
                                            <td
                                                class="px-3 py-5 border-b border-gray-200 bg-white text-sm"
                                            >
                                                {{ dato.nombre }}
                                            </td>
                                            <td
...
const calcularMedianaFunc = (data) => {
    ...
    return data.length % 2 !== 0
        ? data[mid]
        : ((data[mid - 1] + data[mid]) / 2).toFixed(2);
};
...
const calcularMedia = computed(() => {
    const fieldData = datosFiltrados.value
        .map((dato) => dato[campoSeleccionado.value])
