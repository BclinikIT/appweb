                                ...
                                <table class="min-w-full leading-normal">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="dato in datosPaginados" :key="dato.id">
                                            ...
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.edad }}</td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.genero }}</td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.peso_en_libras }}</td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.altura_en_cms }}</td>
