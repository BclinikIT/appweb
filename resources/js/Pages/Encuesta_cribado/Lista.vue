        ...
        <div class="container mx-auto px-4 sm:px-8">
            <div class="py-8">
                ...
                <div class="flex flex-row mb-1 sm:mb-0 justify-between w-full">
                    <h2 class="text-2xl leading-tight">Encuesta Cribado</h2>
                    <div class="flex">
                        ...
                        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden ">
                                <table class="min-w-full leading-normal">
                                    <thead>
                                        <tr>
                                            <th class="fixed-column px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Nombre
                                            </th>
                                            <th class="fixed-column px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Apellido
                                            </th>
                                            <th class="px-2 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Edad
                                            </th>
                                            ...
                                            <th class="px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Horarios refacciones comidas
                                            </th>
                                            <th class="px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Porciones pequeñas
                                            </th>
                                            <th class="px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Separar combinar alimentos
                                            </th>
                                            <th class="px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Rutina ejercicio
                                            </th>
                                            ...
                                            <th class="px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Elevaciones azúcar embarazo
                                            </th>
                                            <th class="px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Síndrome ovarios poliquístico
                                            </th>
                                            <th class="px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Sobrepeso
                                            </th>
                                            <th class="px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Diabetes embarazo hijo
                                            </th>
                                            <th class="px-3 py-2 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                            Ejercicio regular
                                            </th>
                                    ...
                                    <tbody>
                                        <tr v-for="dato in datosPaginados" :key="dato.id">
                                            <td class="fixed-column px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.nombre }}</td>
                                            <td class="fixed-column px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.apellido }}</td>
                                            <td class="px-2 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.edad }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.genero }}</td>
                                            <td class="px-2 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.peso_en_libras }}</td>
                                            <td class="px-2 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.altura_en_cms }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.correo }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.telefono_personal }}</td>
                                            ...
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.separar_combinar_alimentos }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.rutina_ejercicio }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.vivir_saludable }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.insulina_alta }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.resistencia_insulina }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.elevaciones_azucar_embarazo }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.sindrome_ovarios_poliquistico }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.sobrepeso }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.diabetes_embarazo_hijo }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.ejercicio_regular }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.ovario_poliquistico }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.padre }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.madre }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.hermanos }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.tios_paternos }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.tios_maternos }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.abuelos_maternos }}</td>
                                            <td class="px-3 py-5 border-b border-gray-200 bg-white text-sm">{{ dato.abuelos_paternos }}</td>
...
const exportData = () => {
    ...
    const rows = datosFiltrados.value.map((dato) => [
        ...
        dato.cintura_en_cms,
        dato.agua_diaria,
        dato.horarios_refacciones_comidas,
        dato.porciones_pequenas,
        dato.separar_combinar_alimentos,
        dato.rutina_ejercicio,
        dato.vivir_saludable,
        dato.insulina_alta,
        dato.resistencia_insulina,
        dato.elevaciones_azucar_embarazo,
        dato.sindrome_ovarios_poliquistico,
        dato.sobrepeso,
        dato.diabetes_embarazo_hijo,
        dato.ejercicio_regular,
        dato.ovario_poliquistico,
        dato.padre,
        dato.madre,
        dato.hermanos,
        dato.tios_paternos,
        dato.tios_maternos,
        dato.abuelos_maternos,
        dato.abuelos_paternos
    ]);
    ...
    XLSX.writeFile(workbook, "encuesta_cribado.xlsx");
};
